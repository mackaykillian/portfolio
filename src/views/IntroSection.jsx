function IntroSection() {
  return (
    <div className="flex h-screen max-h-[80vh] w-full flex-col -space-y-10 sm:max-h-screen sm:space-y-0">
      ...
      <div className="flex h-[50vh] grow flex-row">
        ...
        <div className="h-[40vh] max-h-[400px] w-[30vh] max-w-[300px] bg-[url('./assets/picture-of-me.png')] bg-cover bg-center"></div>
