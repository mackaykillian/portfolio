...
function SummarySection() {
  ...
  return (
    <div className="h-screen w-full">
      <div className="font-display mb-20 text-[40px] font-black text-neutral-700 sm:mb-40 sm:text-[48px] xl:text-[60px]">
      ...
      <div className="md:flex md:flex-row md:space-x-20">
        ...
        <div className="font-display text-neutral-500 md:w-1/3">
