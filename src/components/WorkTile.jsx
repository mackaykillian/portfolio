...
function WorkTile({ size }) {
  return <>
    {size == 'lg' ? <div className="flex flex-row border-t border-b border-neutral-900 p-8 space-x-10 max-w-[800px]">
      <div className="h-[400px]">
        <div className="w-[400px] h-[400px] bg-neutral-400"></div>
      </div>
      <div className="text-neutral-900 flex flex-col justify-between h-[400px]">
    ...
    </div> : <div className="flex flex-col space-y-10 border-t border-b border-neutral-900 p-8">
      <div>
